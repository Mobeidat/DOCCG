...
<div class="updated notice is-dismissible docnotice">
	...
	<p><?php echo sprintf( esc_html__("Thank you for your choice. To make full use of all the features of the theme, you have to go to our %1\$s welcome page %2\$s", 'doc-text'), '<a href="' . esc_url( admin_url( 'themes.php?page=admin-started' ) ) . '">', '</a>' ); ?></p>
	<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=admin-started' ) ); ?>" class="button button-blue-secondary button_info" style="text-decoration: none;"><?php echo esc_html__('Start using','doc-text'); ?></a></p>
</div>
<?php
}
}
