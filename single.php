...
<body>
    <div id="warp">
        <header id="site-hea">
            <div class="site-hea-left">
                <a href="#" id="menu-toggle" class="toggle"><i class="fa fa-bars"></i></a>
                <h1 class="site-title"><a href="">DOCCG</a><span>2020</span></h1>
            </div>
            <div class="site-hea-right">
                ...
                <a href="#" id="search-toggle" class="toggle"><i class="fa fa-search"></i></a>
            </div>
        </header>
        <main id="site-main">
            <section class="breadcrumbs">
                <div class="max-width">
                    <a href="">首页</a><span> &raquo; </span><span>wordpress</span>
                </div>
            </section>
                ...
                <article class="single-post">
                    <header class="single-hea">
                        <div class="single-meta">
                            ...
                            <span class="single-read"><i class="fa fa-calendar-o"></i>6分钟阅读</span>
                            <span class="single-cat"><a href="">wordpress</a></span>
                        </div>
                        <h3 class="single-title">50+最好的WordPress插件免费和高级50+最好的WordPress插件免费和高级</h3>
                    </header>
                    <main class="single-content">
                        最好的WordPress插件。具有内置的WordPress主题功能并非总是一个选择（或最佳选择），因此我们编制了免费和高级的最佳WordPress插件列表
                    </main>
            ...
            <section class="single-pnext">
                <a href="">50+最好的WordPress插件免费和高级50+最好的WordPress插件免费和高级</a><a href="">50+最好的WordPress插件免费和高级50+最好的WordPress插件免费和高级</a>
            </section>
        </main>
        <footer id="site-foo">
            ...
            <section class="copyright">
                <p>© 2016-2020 | DOCCG</p>
                <div><a href="">使用条款</a><a href="">隐私</a><a href="">帮助</a></div>
            </section>
        </footer>
        <div id="fixed-box">
            <a href="#" id="bell"><i class="fa fa-bell"></i></a>
